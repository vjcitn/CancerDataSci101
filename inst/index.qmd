...
intro <- tryCatch(
    {
        description <- packageDescription("CancerDataSci101")
...
This is the landing page of the `BiocBook` for the Dana-Farber YES for CURE
Cancer Data Science summer curriculum.

A concept map of the contents as of September 2023 is:

<img src="YESCDS_map.png" height="350px"/>

# Docker image {-}

A `Docker` image built from this repository is available here: 

👉 [ghcr.io/vjcitn/cancerdatasci101](https://ghcr.io/vjcitn/cancerdatasci101) 🐳
...
#| eval: false
docker run -it ghcr.io/vjcitn/cancerdatasci101:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/vjcitn/cancerdatasci101:devel
```
...
#| eval: false
docker run -it ghcr.io/vjcitn/cancerdatasci101:devel bash
